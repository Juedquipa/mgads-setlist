...
from .models import PinCode, Session, Track, Request, PlaybackQueue

class PinCodeSerializer(serializers.ModelSerializer):
    class Meta:
        model = PinCode
        fields = ["id", "code", "credits", "is_used", "created_by", "table", "created_at", "used_at"]
        read_only_fields = ["id", "code", "is_used", "created_by", "created_at", "used_at"]

class SessionSerializer(serializers.ModelSerializer):
    class Meta:
        model = Session
        fields = ["id", "token", "credits_balance", "is_active", "table", "created_at", "expires_at"]
